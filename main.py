...
st.html(
    """<div>
        ...
        <p>language = st.selectbox("Pick one", ["hindi", "english"])</p>
        <p>topic = st.text_input("Topic")</p>
        <p>number = st.number_input("Number of tweets", min_value = 1, max_value = 10, value = 1, step = 1)</p>
    </div>""")
